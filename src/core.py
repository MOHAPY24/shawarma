...
def factual_start():
    ...
    factual_prompt = f"give a factual answer/choice to this text from a user, be detailed too: {user_input}"
...
def creative_start():
    ...
    creative_prompt = f"{curr_data}, give a creative answer/choice to this text from a user, you may use the JSON response from a model ment to give a factual response to the said text to use it on your own way, be detailed too: {user_input}"
...
def practical_start():
    ...
    practical_prompt = f"{curr_data}, give a practical answer/choice to this text from a user, you may use the JSON response from 2 models ment to give a factual and creative choice to said text response to the said text to use it on your own way, be detailed too: {user_input}"
...
while True:
    try:
        ...
        factual_prompt = f"{curr_data}, using the JSON just passed to you, do not add or modify any information given. Merge all information into one detailed paragraph."
